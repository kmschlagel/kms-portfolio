    ...
    <div id="right_column" class="clearfix">
    	<h2><?php echo $tag_name; ?> </h2>
         ...
         <div class="blog_entry clearfix">
          	<?php echo '<img src="lg_blog_images/' . $entry_single['entryID'] . '.' . $entry_single['file_ext'] . '">'; ?>
            <h4><?php echo $entry_single['entryName']; ?></h4>
            <?php echo $entry_single['entryDescFull']; ?>
            <a href="entries.php?tag_id=<?php echo $entry_single['tagID']; ?>">#<?php echo $entry_single['tagName']; ?> </a>
            <a href="weights.php">See yarn</a>
            
         </div> <!-- /.blog_entry -->
         <a href="entries.php?tag_id=<?php echo $entry_single['tagID']; ?>" style="margin-left: 4%; font-family: 'prestige_elite_stdbold';">Back to <?php echo $entry_single['tagName']; ?> </a>
