<?php
	$tmp_path = GW_UPLOADPATH_BLOG . $image_id . '.' . $file_ext; //tmp path of the image
	$lg_path = GW_UPLOADPATH_BLOG_LG . $image_id . '.' . $file_ext; //the path of lg image
	$sm_path = GW_UPLOADPATH_BLOG_SM . $image_id . '.' . $file_ext; //the path of sm image
	if($file_ext == jpg)
	{ 
