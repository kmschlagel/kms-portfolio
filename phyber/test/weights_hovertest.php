...
<div id="page" class="clearfix"> 
    ...
    <div id="right_column" class="clearfix">
    	<h2>Yarn (by weight)</h2>
          <ul>
            <?php foreach($weights_menu as $weight_menu) : ?>
        	<li class="box"><a href="products_hovertest.php?weight_id=<?php echo $weight_menu['weightID']; ?>"><p><?php echo $weight_menu['weight']; ?></p><?php echo '<img src="img/sm_cat_images/' . $weight_menu['weightID'] . '.' . $weight_menu['file_ext'] . '">'; ?></a></li>
            <?php endforeach; ?>
          </ul>
  	</div> <!--/#right column-->
